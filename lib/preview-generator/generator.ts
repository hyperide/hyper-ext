...
function buildErrorBoundary(): string[] {
  return [
    ...
    '      return (',
    "        <div style={{ padding: 24, fontFamily: 'system-ui, -apple-system, sans-serif', maxWidth: 480 }}>",
    "          <h3 style={{ color: '#e53e3e', margin: '0 0 8px', fontSize: 16, fontWeight: 600 }}>",
    "            {looksLikePropsError ? 'Component needs props' : 'Render Error'}",
    '          </h3>',
    "          <p style={{ color: '#718096', fontSize: 13, margin: '0 0 16px', lineHeight: 1.5 }}>",
    "            <strong style={{ color: '#4a5568' }}>{componentPath}</strong>",
    "            {looksLikePropsError ? ' requires props to render correctly.' : ' crashed during render.'}",
    '          </p>',
    ...
    '            </button>',
    '          </div>',
    "          <p style={{ color: '#a0aec0', fontSize: 12, margin: '12px 0 0', lineHeight: 1.5 }}>",
    '            With an AI key configured, props will be filled automatically.',
    '            Or create a sample file to define props manually.',
    '          </p>',
    '          <details style={{ marginTop: 16 }}>',
    "            <summary style={{ color: '#a0aec0', cursor: 'pointer', fontSize: 12, userSelect: 'none' }}>",
    '              Error details',
    '            </summary>',
    "            <pre style={{ fontSize: 11, color: '#e53e3e', whiteSpace: 'pre-wrap', marginTop: 8, padding: 8, background: '#fff5f5', borderRadius: 4, overflowX: 'auto' }}>",
    '              {errorMessage}',
    '            </pre>',
    '          </details>',
    '        </div>',
