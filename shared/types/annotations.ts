 ...
 */
export function isArrowAnnotation(annotation: AnnotationElement): annotation is ArrowAnnotation {
 ...
 */
export function isTextAnnotation(annotation: AnnotationElement): annotation is TextAnnotation {
