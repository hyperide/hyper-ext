...
export function PropsForm({
  ...
  // Build field list early so we can auto-generate in the initial state
  ...
  const [values, setValues] = useState<Record<string, unknown>>(() => {
    ...
    // Auto-generate on mount when required fields exist
  ...
  // Notify parent about initial generated values
