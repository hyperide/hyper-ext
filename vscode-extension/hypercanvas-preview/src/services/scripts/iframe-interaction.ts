...
import type { LocalResolveResult, OverlayElementResolver, OverlayRect, TracingResolver } from '@shared/canvas-interaction/types';
import {
  type Fiber,
  FiberTag,
...
window.addEventListener('message', (event: MessageEvent) => {
  ...
  if (msg.type === 'hypercanvas:stateUpdate') {
    ...
    if (msg.writeInProgress !== undefined) state.writeInProgress = msg.writeInProgress;
    needsOverlayUpdate = true;
    scheduleOverlayLoopIfNeeded();
