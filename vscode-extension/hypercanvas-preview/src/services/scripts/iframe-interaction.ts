...
// and the iframe becomes unusable until reload.
document.addEventListener('pointercancel', _dragCleanup, true);
document.addEventListener('lostpointercapture', _dragCleanup, true);
