...
// biome-ignore lint/suspicious/noControlCharactersInRegex: ESC byte is intentional for ANSI stripping
const ANSI_RE = /\x1B\[[0-9;]*[a-zA-Z]/g;
/** Strip ANSI escape codes from server output (Vite colored terminal output). */
