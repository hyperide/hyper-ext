...
export class AstBridge {
  ...
  /**
   * Handle moveElement message — moves any JSX element to any place. Unlike
   * `_handleReorderElement` this does NOT require source/target to share a
   * direct JSX parent: cross-parent, cross-component, and cross-file moves
   * are all supported. Cross-file moves return `allCrossFileSnapshots`
