...
- [x] Run: `bun test shared/canvas-interaction/keyboard-handler.test.ts` (if exists)
- [x] Run: `bun test shared/canvas-interaction/overlay-rects.test.ts` (if exists)
- [x] Run typecheck: `bun run typecheck`
- [x] Fix any type errors from signature changes
...
- [x] Find screenshot from E2E run showing single rect after Shift+Enter
