...
- [x] Run E2E against bulka-the-dog. Open every passed frame via Read.
      ...
      text with the blue selection outline; 500/1200/1800ms frames show
      the post-rewrite "Hi! I'm Bulka the dog!" text (because
...
- [x] Send only when outline is present in the LAST frame; otherwise the
      ...
      frames + intro to Telegram (message_ids 1217–1223). LAST frame
      (1800ms) shows the post-rewrite text "Hi! I'm Bulka the dog!"
      wrapped in the blue selection outline, anchored to the original
      `<p>` source location — exactly the contract the user reported as
      broken.
