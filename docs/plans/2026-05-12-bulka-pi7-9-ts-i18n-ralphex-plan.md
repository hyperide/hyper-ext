...
- [ ] Run the spec, capture output with `tail -80`.
- [ ] All three tests show PASSED (not skipped, not failed).
- [ ] Screenshot saved at `/tmp/bulka-i18n-pi7-9-GREEN.png` or equivalent path.
- [ ] Open screenshot with Read tool. Visually confirm: all 3 tests green, no skip markers.
