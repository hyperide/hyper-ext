  ...
  return (
    <YStack flex={1} justify="center" items="center" gap="$8" p="$4" bg="$background">
      ...
      <YStack gap="$4">
        ...
        <Separator />
        <Paragraph text="center">This screen uses the same code on Next.js and React Native.</Paragraph>
        <Separator />
      </YStack>
      ...
      >
        ...
        <Sheet.Frame items="center" justify="center" gap="$10" bg="$color2">
          <XStack gap="$2">
            ...
            <Anchor color="$blue10" href="https://github.com/tamagui/tamagui" target="_blank" rel="noreferrer">
              give it a ⭐️
            </Anchor>
          </XStack>
