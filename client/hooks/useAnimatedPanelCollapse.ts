...
export function useAnimatedPanelCollapse(
	...
	options: { collapsedSize?: number; canExpand?: boolean; onCollapseStart?: () => void; onExpandStart?: () => void } = {},
) {
	...
	const animateToSize = useCallback((fromSize: number, toSize: number, onComplete?: () => void) => {
