...
export default function ProjectSettings() {
	...
	const isCommandsDirty = () => {
		return (
			project &&
			(commandsForm.installCommand !== project.installCommand ||
				commandsForm.devCommand !== project.devCommand)
		);
	};
	...
	if (loading) {
		return (
			<div
				data-uniq-id="ed473358-fe81-4aed-88c1-db1a506251e4"
			...
			>
				...
				>
					<div
						data-uniq-id="62c84ce8-8bd4-4095-87a2-e72343efadb7"
					...
					>
						...
						/>
						<p
							data-uniq-id="2a39aa80-ee2a-4a79-b08a-0dfb8ed2658a"
	...
	if (error || !project) {
		return (
			<div
				data-uniq-id="18bdaae9-fde5-41d6-9e5d-22a3ff6a48e7"
				className="container mx-auto p-8"
			>
				<div
				...
				>
					<div
						data-uniq-id="4657dec5-a6b6-4d59-9e77-25571a5374cc"
						className="text-center space-y-4"
					>
						<p
							data-uniq-id="ba5cd042-4a44-4885-a0b3-3f774792de77"
							className="text-lg text-destructive"
						>
							{error || 'Project not found'}
						</p>
						<Button
							data-uniq-id="7f6b5a1c-cd27-4868-910f-d189790330f8"
							onClick={() => navigate('/projects')}
						>
							<IconArrowLeft
								data-uniq-id="693f3eaa-fd36-49ba-a0ef-3b23b6284568"
								size={16}
								className="mr-2"
							/>
							Back to Projects
	...
	return (
		...
		>
			<div
				data-uniq-id="af50f324-d55d-40c4-9a47-626fcf512c73"
				className="flex items-center justify-between"
			>
				<div
					data-uniq-id="156cf6a2-a407-40b4-bbae-8cc8574d6a9d"
				...
				>
					...
					>
						<IconArrowLeft
							data-uniq-id="20d724e5-6b8a-45aa-b9d0-9cc3dcf2bae4"
							size={16}
						/>
					</Button>
					<div data-uniq-id="6e8c75b4-90dd-452b-b776-d74ab41dfaf2">
						<h1
							data-uniq-id="c72ccdb2-4068-4d41-aed5-b4f4d73386da"
							className="text-3xl font-bold"
						>
							{project.name}
						</h1>
						<p
							data-uniq-id="20b48a2b-cb16-4e63-8487-85c980894152"
				...
				<div
					data-uniq-id="d5e84337-40c7-4a96-8732-4787cf42bcb7"
				...
				>
					{project.status === 'running' ? (
						...
						>
							<IconPlayerStop
								data-uniq-id="0092457e-9c0e-4304-9b5f-8a7b2ca1a742"
								size={16}
								className="mr-2"
							/>
							Stop
						...
						>
							<IconPlayerPlay
								data-uniq-id="2587e5d2-d922-4636-bd67-57badcf6c046"
								size={16}
								className="mr-2"
							/>
							Start
			...
			<div
				data-uniq-id="fb7d67c9-6edd-4469-b226-8a0527a79824"
			...
			>
				<Card data-uniq-id="46831d78-5dcd-4681-a842-626c88196e61">
					<CardHeader data-uniq-id="2c7d0406-8d60-448f-afaf-c781344e19b4">
						<CardTitle data-uniq-id="c8bc3a34-54d5-430e-8576-bc550c58f39d">
							Project Info
						</CardTitle>
					...
					<CardContent
						data-uniq-id="5eee956a-26e3-464b-a4b5-8acbcb6becf2"
						className="space-y-2"
					>
						<div data-uniq-id="6ead3905-c07c-4dd6-baac-3d0b98ac7b03">
							<span
								data-uniq-id="cb1e3ffe-aa20-499d-ba8e-1c7e5bee79a8"
						...
						<div data-uniq-id="f0695f12-0c2d-476f-8670-f89b72e249b9">
							<span
								data-uniq-id="7e45588d-62dd-41f8-b533-9e5c8a02493b"
								className="font-semibold"
							>
								Status:
							</span>{' '}
						...
						<div data-uniq-id="d0994d50-5b35-4a1e-a26a-68740d13ff3d">
							<span
								data-uniq-id="7747025a-feea-4282-80b9-19e0298d1e22"
								className="font-semibold"
							>
								Port:
							</span>{' '}
						...
						<div data-uniq-id="865f78a4-7585-4284-a3d2-7c3b532dfdd5">
							<span
								data-uniq-id="0da2582c-f8bd-476e-bc4a-6edb9a467362"
								className="font-semibold"
							>
								Created:
							</span>{' '}
				...
				<Card data-uniq-id="7d8520fa-c686-400c-bfbf-a7a926c442a0">
					<CardHeader data-uniq-id="ee586ab9-2553-4fa8-b1eb-7338087c6ce0">
						<CardTitle data-uniq-id="c5d71b6d-7017-478d-8b58-210baec8f65c">
							Commands
						</CardTitle>
					...
					<CardContent
						data-uniq-id="41b93288-bb98-46f2-967e-8f4a229b6179"
						className="space-y-4"
					>
			...
			<Card data-uniq-id="fa4bd2fa-7e38-482b-838c-bf57826ce38e">
				<CardHeader data-uniq-id="68b1c6c7-abb9-45e6-82e9-ea1f72c2a281">
					<CardTitle data-uniq-id="8e02ff81-a0e7-45a1-9060-018d3748a1af">
						Docker Logs
					</CardTitle>
