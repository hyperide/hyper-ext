...
export function ProjectStartOverlay({
					...
					<div className="h-full flex items-center justify-center">
						<div className="text-center space-y-4">
							...
							<p className="text-lg text-muted-foreground">
								Starting project "{project?.name || 'Project'}"...
							</p>
	...
	return (
		...
		>
			<div
				data-uniq-id="90c45f36-57af-487f-9a9b-4708dd7a2bfb"
				className="text-center space-y-4"
			>
				<p
					data-uniq-id="ad066f8c-0edc-46de-baf3-1ac5c9ef769f"
					className="text-lg text-muted-foreground"
				>
					{project ? `Project "${project.name}" is stopped` : 'No active project'}
				</p>
				<p
					data-uniq-id="6d7e53bb-eaaa-425d-ba75-b2703160c34c"
				...
				{project && (
					...
					>
						<IconPlayerPlay
							data-uniq-id="13c1c0a2-2911-4a85-bc75-63f6cbedfa68"
