...
const ERROR_MESSAGES: Record<string, string> = {
	...
	'Could not get email from GitHub': 'Could not retrieve your email from GitHub. Please ensure your GitHub account has a verified email address.',
					...
					{error === 'Could not get email from GitHub' && (
						<div className="p-4 rounded-md bg-muted text-sm text-muted-foreground">
							...
							<ol className="list-decimal list-inside space-y-1">
								<li>Go to <a href="https://github.com/settings/emails" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">GitHub Email Settings</a></li>
