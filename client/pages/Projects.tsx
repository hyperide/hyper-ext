...
const FRAMEWORK_DEFAULTS: Record<
	Framework,
	{ devScript: string; internalPort: number }
> = {
...
const areCommandsDefault = (
	...
	return packageManagers.some((pm) => {
		...
		return (
			defaults.devCommand === currentDevCommand &&
			defaults.installCommand === currentInstallCommand
		);
	});
};
...
export default function Projects() {
	...
	useEffect(() => {
		if (
			...
			gitUrl === '' &&
			document.activeElement === gitUrlInputRef.current
		) {
	...
	const handleFrameworkChange = (newFramework: Framework) => {
		...
		const { devCommand: newDevCommand, installCommand: newInstallCommand } =
			getDefaultCommands(newFramework, packageManager);
	...
	const handlePackageManagerChange = (newPackageManager: PackageManager) => {
		...
		if (areCommandsDefault(devCommand, installCommand, framework)) {
			const { devCommand: newDevCommand, installCommand: newInstallCommand } =
				getDefaultCommands(framework, newPackageManager);
			setDevCommand(newDevCommand);
			setInstallCommand(newInstallCommand);
		}
	};
	...
	const handleCloneRepo = async (e: React.FormEvent) => {
		...
		try {
			...
			if (installCommand.trim())
				requestBody.installCommand = installCommand.trim();
	...
	const handleStartProject = async (projectId: string) => {
		...
		setProjects((prev) =>
			prev.map((p) => (p.id === projectId ? { ...p, status: 'building' as const } : p)),
		);
		try {
			...
			// Revert on error
			setProjects((prev) =>
				prev.map((p) => (p.id === projectId ? { ...p, status: 'stopped' as const } : p)),
			);
		}
	};
	...
	if (loading) {
		return (
			...
			>
				<p
					data-uniq-id="68676c4b-77f5-421a-80b2-8815c7d9cda6"
	...
	return (
		...
		>
			<div
				data-uniq-id="14dfd4ef-e4a6-403a-bbbf-a6a3e494a693"
				className="max-w-6xl mx-auto space-y-6"
			>
				<div
					data-uniq-id="0a04fa75-200e-4cdd-8570-79e0977f5dd4"
					className="flex items-center justify-between gap-4"
				>
					<div
						data-uniq-id="e528f01a-a8ad-441f-8ba3-b94926a4b43b"
						className="min-w-0"
					>
						<div className="flex items-center gap-3 mb-2 flex-nowrap">
							<h1
								data-uniq-id="c942a51a-4970-4e45-8271-da6482352117"
								className="text-4xl font-bold shrink-0"
							>
								Projects
							</h1>
							{(pollingNetworkError || !isOnline) && (
								<NetworkStatusIndicator variant="badge" isOffline={!isOnline} />
							)}
							...
							>
								<PopoverTrigger asChild>
									<Button
										variant="ghost"
										className="text-2xl font-semibold h-auto py-1 px-2 max-w-[300px]"
									>
						...
						<p
							data-uniq-id="69cc37b4-30e7-42ba-9420-b7b03f458255"
					...
					<div
						data-uniq-id="5efeb085-7b75-4622-8010-3af39523decf"
					...
					>
						...
						>
							<IconSparkles
								data-uniq-id="214285dd-c66c-49fd-b030-f119b4be51e3"
						...
						>
							<IconBrandGit
								data-uniq-id="e1bd25bf-fa97-4ff4-bf7f-47f5981b3b88"
								className="w-4 h-4 mr-2"
							/>
							Clone from Git
						</Button>
						...
						>
							<IconBrandGithub
								data-uniq-id="5b042016-7f65-445d-9e54-f83b4114ce68"
								className="w-4 h-4"
							/>
						</Button>
					</div>
				...
				{showGitClone && (
					<Card data-uniq-id="50f0b38f-929a-46a7-93f4-0c840d2e116f">
						<CardHeader data-uniq-id="47f95375-29fe-4c75-9d28-a955b5131ee2">
							<CardTitle data-uniq-id="30b01508-af6c-48ef-a8f8-5edf2acb1373">
								Clone Git Repository
							</CardTitle>
							<CardDescription data-uniq-id="d86b3845-6938-449b-93f8-81799f59b060">
								Clone a repository via SSH or HTTPS URL. The project will be
						...
						<CardContent data-uniq-id="bca5fb85-ea9b-4afb-8bc4-749666bb9054">
							...
							>
								<div
									data-uniq-id="b3e0a7cd-b787-4343-8042-2141ff0edacc"
									className="space-y-2"
								>
									<Label
										data-uniq-id="8a758382-a189-4f7d-ab15-ded707578fe3"
										htmlFor="gitUrl"
									>
										Git URL
									</Label>
									<div
										data-uniq-id="31d6d7eb-2d80-4577-9b9d-5c8404bfbb89"
									...
									>
										<Input
											...
											onFocus={() =>
												githubRepos.length > 0 && setGitUrlPopoverOpen(true)
											}
											required
											className="flex-1"
										/>
										{githubRepos.length > 0 && (
											...
											>
												<PopoverTrigger
													data-uniq-id="4699134f-1727-403a-b405-974a08eef847"
													asChild
												>
													<Button
													...
													>
														<IconBrandGithub
															data-uniq-id="47cb0ae5-8ee9-47b2-ad0b-98ce5416fb6f"
															className="w-4 h-4"
														/>
													</Button>
												</PopoverTrigger>
												...
												>
													<Command data-uniq-id="7d97e6de-951a-4071-bd42-49acb296f2fd">
														<CommandList data-uniq-id="9d1d672d-c290-4be7-9829-c1de1566cc52">
															...
															<CommandGroup>
																<CommandItem
																	onSelect={handleConnectGitHubApp}
									...
									<div
										data-uniq-id="3312984f-abc5-42e9-b0c4-e31333360abc"
										className="space-y-2"
									>
										<p
											data-uniq-id="a1d607bf-1550-482c-90c2-345a0c2e4a28"
										...
										>
											<p
												data-uniq-id="34dfa8b4-4eb6-4421-b0de-8537f683cbff"
												className="text-sm text-blue-900"
											>
												<strong data-uniq-id="921f5f62-17a7-4a2f-82ec-13e83f9348b4">
													Recommendation:
												</strong>{' '}
												Use SSH URLs (git@github.com:...) for full read/write
												access. HTTPS URLs provide read-only access unless you
								...
								<div
									data-uniq-id="fd81cf9d-b715-4fae-b137-a6518b7cfd24"
									className="space-y-2"
								>
									<Label
										data-uniq-id="32a06509-0566-4841-8bf2-219bfe0ce2f1"
										htmlFor="projectName"
									>
									...
									/>
									<p
										data-uniq-id="e44e1f15-24dc-4e24-b22d-f4de93d9decc"
								...
								<div
									data-uniq-id="64dd3cb4-d10e-403a-a4a6-a2379d17e7b6"
									className="space-y-2"
								>
									<Label
										data-uniq-id="e713efcf-1c4c-48cb-b7b3-56431c09b7ba"
										htmlFor="framework"
									>
										Framework
									</Label>
									...
									>
										<option
											data-uniq-id="d9f184e9-d495-4002-a4bf-93245feec5aa"
											value="vite"
										>
											Vite (React)
										</option>
										<option
											data-uniq-id="834bc08a-17a4-4ff5-bec9-e97778bbb435"
											value="next"
										>
											Next.js
										</option>
										<option
											data-uniq-id="d5e30515-fe98-4ad9-9b56-560d7150b12d"
											value="remix"
										>
											Remix
										</option>
										<option
											data-uniq-id="3f20125a-b7eb-4813-9846-b14188adbe2e"
											value="cra"
										>
											Create React App
										</option>
									...
									<p
										data-uniq-id="1244e471-5623-47bb-9577-945109e9706d"
										className="text-xs text-muted-foreground"
									>
								...
								<div
									data-uniq-id="0130fd0c-b936-48e2-9b31-d7b37d96cb24"
									className="space-y-2"
								>
									<Label
										data-uniq-id="66143c3d-11a1-48bb-8d54-fbcd0e9248a6"
									...
									>
										<option
											data-uniq-id="ac0103c4-fb5d-4616-ac63-aea9a310aaea"
											value="npm"
										>
											npm
										</option>
										<option
											data-uniq-id="d6114f3e-3959-4b79-8d71-866385be0c5f"
											value="yarn"
										>
											yarn
										</option>
										<option
											data-uniq-id="4e92fecd-671f-4c30-a958-6cfb835f03ee"
											value="pnpm"
										>
											pnpm
										</option>
									...
									<p
										data-uniq-id="4ddf472d-2cfb-4847-8bbb-84e16fa05dd6"
										className="text-xs text-muted-foreground"
									>
								...
								<div
									data-uniq-id="f68e5119-3ae6-42e9-a530-c59eac75cd56"
									className="space-y-2"
								>
									<Label
										data-uniq-id="6fe7fd62-e2a4-4ffb-adec-39d6116ccbe8"
									...
									/>
									<p
										data-uniq-id="31c22312-f7cc-4651-ae04-bdf32fbdf8ed"
										className="text-xs text-muted-foreground"
									>
								...
								<div
									data-uniq-id="ac6bdeec-f27b-42bc-8bd4-556abd55fe8c"
									className="space-y-2"
								>
									<Label
										data-uniq-id="b21fdc4b-8083-48e8-abab-223e62e3f55a"
										htmlFor="devCommand"
									>
										Dev Command
									</Label>
									...
									/>
									<p
										data-uniq-id="6077055f-f5e4-4346-945c-2566c1a8c8ed"
										className="text-xs text-muted-foreground"
									>
										Command to start the dev server (auto-filled based on
										framework)
									</p>
								</div>

								<div
									data-uniq-id="e1ac4b34-f57b-4c40-9edf-c15182c6ca9f"
									className="space-y-2"
								>
									<Label
										data-uniq-id="b3fa7ee6-c8d0-4e8e-a0a0-840a49fb62e6"
									...
									/>
									<p
										data-uniq-id="be61f8c0-9c60-4e18-88f7-6d053179f791"
										className="text-xs text-muted-foreground"
									>
										Port inside Docker container (auto-filled based on
										framework)
									</p>
								</div>
								...
								{cloning && (
									...
									>
										<p
											data-uniq-id="4b7fc228-b09c-4fef-b897-73688845f507"
								...
								<div
									data-uniq-id="9b2d3a6e-a0ab-49bd-adf2-697daee8a836"
									className="flex gap-2"
								>
									<Button
										data-uniq-id="1a6b8437-a34f-4599-a11a-2086035645e0"
										type="submit"
										disabled={cloning}
									>
				...
				<div
					data-uniq-id="15921f9e-72fc-491b-9243-6c10f55ca65a"
				...
				>
					{projects.length === 0 ? (
						<Card data-uniq-id="f40f1f12-0709-4b4b-bcc2-ab6d8ceda337">
							...
							>
								<p
									data-uniq-id="7328d71b-757d-4805-ab9a-7452a2fa06e3"
									className="text-lg text-muted-foreground mb-4"
								>
									No projects yet
								</p>
								<Button
									data-uniq-id="c0b69bc3-d6c2-4b42-82a1-b2428b6283dd"
									onClick={() => setShowGitClone(true)}
								>
									<IconBrandGit
										data-uniq-id="47abcc67-9970-41b7-ac31-e0cbd43c6a7b"
										className="w-4 h-4 mr-2"
									/>
						...
						projects.map((project) => (
							...
							>
								<CardContent
									data-uniq-id="cda6f025-d83b-4ad6-9ae3-9a78c8eddab1"
									className="p-6"
								>
									...
									>
										...
										<div
											data-uniq-id="b64e2da5-74d6-481b-9b0f-80415d10ce1a"
										...
										>
											...
											>
												<IconSettings
													data-uniq-id="e9f70738-c2f6-4a4c-93fa-967ce75a9860"
													className="w-4 h-4"
												/>
											</Button>
									...
									<div className="mt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
										<div
											data-uniq-id="6da539d1-c798-48e1-885c-47479122c23f"
											className="min-w-0"
										>
											<p
												data-uniq-id="de8dc493-1c82-4e99-9581-2d9110c1812e"
												className="text-sm text-muted-foreground"
											>
											...
											{project.githubRepoUrl && (
												...
												>
													<IconBrandGit
														data-uniq-id="f172c074-41a4-4e78-a73c-ce3f48fd84c7"
														className="w-4 h-4"
													/>
													View on GitHub
												</a>
										...
										>
											<span data-uniq-id="b6b7a2c8-ed40-4df2-81cb-d90317eb7c78">
												Framework: {project.framework}
											</span>
											<span data-uniq-id="9cceff7e-1ed3-443d-862e-a3c1e8d3d993">
												Port: {project.internalPort}
											</span>
											<span data-uniq-id="cfd52ee6-518a-4116-924d-1a2f70da13c4">
												Dev: {project.devCommand}
											</span>
											<span data-uniq-id="f7f193b7-b1a7-4351-9b7e-d553cc3ad9c4">
			...
			{showCreateSidebar && (
				...
				>
					<ProjectCreationAIChat
						...
						existingProject={continueProject ? {
