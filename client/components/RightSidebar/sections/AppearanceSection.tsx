				...
				<div className="flex items-center gap-2 mb-2">
					<div className="flex-1 h-6 px-2 bg-muted rounded flex items-center gap-1">
						...
						<Input
							...
							onKeyDown={(e) =>
								onNumericKeyDown(e, opacity, onOpacityChange, 'opacity')
							}
							placeholder="100"
					...
					<div className="grid grid-cols-2 gap-2 w-sidebar-content">
						<div className="h-6 px-2 bg-muted rounded flex items-center gap-1">
							...
							<Input
								...
								onChange={(e) =>
									handleCornerRadiusChange('topLeft', e.target.value)
								}
								onKeyDown={(e) =>
									onNumericKeyDown(
										e,
						...
						<div className="h-6 px-2 bg-muted rounded flex items-center gap-1">
							...
							<Input
								...
								onChange={(e) =>
									handleCornerRadiusChange('topRight', e.target.value)
								}
								onKeyDown={(e) =>
									onNumericKeyDown(
										e,
						...
						<div className="h-6 px-2 bg-muted rounded flex items-center gap-1">
							...
							<Input
								...
								onChange={(e) =>
									handleCornerRadiusChange('bottomLeft', e.target.value)
								}
								onKeyDown={(e) =>
									onNumericKeyDown(
										e,
						...
						<div className="h-6 px-2 bg-muted rounded flex items-center gap-1">
							...
							<Input
								...
								onChange={(e) =>
									handleCornerRadiusChange('bottomRight', e.target.value)
								}
								onKeyDown={(e) =>
									onNumericKeyDown(
										e,
