...
function formStateToUpdates(formState: FormState): Partial<Project> {
  return {
    ...
    atomComponentsPaths:
      formState.atomComponentsPaths.length > 0 ? formState.atomComponentsPaths.filter(Boolean) : null,
    compositeComponentsPaths:
      formState.compositeComponentsPaths.length > 0 ? formState.compositeComponentsPaths.filter(Boolean) : null,
    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground mt-2">Please open a project first.</p>
        </CardContent>
      </Card>
    );
  }
