...
import type { CreateRepoData, GitHubAppInstallation, GitHubRepository } from './types';
...
export function GitHubRepoModal({ open, onOpenChange, onSelect, onCreate }: GitHubRepoModalProps) {
  ...
  const { organizations, user, loading: orgsLoading, refetch: refetchOrgs } = useGitHubOrganizations();
  ...
  const { installations, getInstallUrl, refetch: refetchInstallations } = useGitHubAppInstallations();
          ...
          <div className="flex items-center justify-between">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={handleReconnect}>Re-authorize GitHub</DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
          </div>
        </DialogHeader>
...
function RepoList({ repositories, existingProjectIds, loading, hasMore, onSelect, onLoadMore }: RepoListProps) {
  ...
  return (
    <ScrollArea className="h-[400px]">
      <div className="space-y-2 pr-4">
        {repositories.map((repo) => {
          ...
          return (
            ...
            >
              ...
              <Button variant={isImported ? 'outline' : 'default'} size="sm" onClick={() => onSelect(repo)}>
        ...
        {hasMore && (
          <Button variant="ghost" className="w-full" onClick={onLoadMore} disabled={loading}>
...
function CreateRepoForm({
  ...
  const hasInstallation = selectedOwner
    ? installations.some((inst) => inst.accountLogin.toLowerCase() === selectedOwner.toLowerCase() && !inst.suspendedAt)
    : false;
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Input id="repo-name" placeholder="my-awesome-project" value={name} onChange={(e) => setName(e.target.value)} />
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-0.5">
          ...
          <p className="text-sm text-muted-foreground">Only you and collaborators can see this repository</p>
        </div>
        ...
        <Alert className="border-amber-500/50 bg-amber-500/10">
          ...
          <AlertDescription className="space-y-3">
            ...
            <div className="flex gap-2">
              <Button type="button" size="sm" onClick={handleInstallApp}>
      ...
      <Button type="submit" className="w-full" disabled={loading || !name.trim() || !hasInstallation}>
