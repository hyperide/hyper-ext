export default function IconBrush({ className = 'w-6 h-6', ...props }: { className?: string; [key: string]: unknown }) {
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 24 24" fill="none" {...props}>
      <g clipPath="url(#clip0_33_8964)">
        <path
        ...
        />
        <path
          d="M21 3C18.1458 3.3904 15.45 4.54414 13.1971 6.33944C10.9441 8.13474 9.2177 10.505 8.2 13.2"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M21 3C20.6096 5.85418 19.4559 8.55002 17.6606 10.8029C15.8653 13.0559 13.495 14.7823 10.8 15.8"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M10.6 9C12.5432 9.89687 14.1031 11.4568 15 13.4"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
