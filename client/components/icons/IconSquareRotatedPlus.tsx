export default function IconSquareRotatedPlus({
  ...
  return (
    <svg aria-hidden="true" className={className} viewBox="0 0 14 14" fill="none" {...props}>
      <g clipPath="url(#clip0_icon_square_rotated_plus)">
        <path d="M5.25 7H8.75" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M7 5.25V8.75" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" />
        <path
