...
export const SampleDefault = () => {
  ...
  return (
      <MemoryRouter
          data-uniq-id="f6dcf57f-eb15-46dd-9f56-4a0d6b6152c3"
          ...
          <div data-uniq-id="dc7895e4-8445-495e-8727-f252752667ed" className="p-6 w-80">
            <FillPicker
                ...
                className="w-full"
                beforeUnlinkSlot={<div
                    data-uniq-id="8f1dd9f5-3abd-4a55-a0ff-b06e45e2bc3d"
                    className="text-xs text-gray-500 mt-2 mb-1">+ Opacity</div>} />
          </div>
          <Routes data-uniq-id="21eab3ef-fe33-4f91-adb1-458f12c23902">
            <Route
                data-uniq-id="73da322f-4dfe-4850-bbc6-f792f6621a0e"
...
export function FillPicker({
	...
	return (
        <div
            ...
            {/* Tab switcher */}
            <div
                data-uniq-id="eea08778-07ef-4670-b8eb-8597c6b20048"
				...
				<button
					...
					<IconPalette
                        data-uniq-id="5349c3fa-7e56-46bd-b3b9-0df2bc2b5428"
                        className="w-4 h-4"
                        stroke={1.5} />
				</button>
				<button
                    ...
                    title={
						publicDirExists
							? 'Background image'
							: 'No public directory found - configure in project settings'
					}
                    className={cn(
					...
					<IconPhoto
                        data-uniq-id="bbf2efdd-ddbb-4aca-904a-ff6c82d6d0bf"
                        className="w-4 h-4"
                        stroke={1.5} />
				</button>
			</div>
