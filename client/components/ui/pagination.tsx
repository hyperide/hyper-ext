...
>(({ className, ...props }, ref) => (
	<li
		data-uniq-id="6e6789bb-fd7d-4f84-857a-61bd760c10cc"
		ref={ref}
...
const PaginationPrevious = ({
	...
	>
		<IconChevronLeft
			data-uniq-id="fc8ebc8d-24a9-44e6-a42d-28e07953fc65"
			className="h-4 w-4"
		/>
...
const PaginationNext = ({
	...
	>
		...
		<IconChevronRight
			data-uniq-id="d9d7d3cc-fe50-4ef1-8056-ae9866bf5ed6"
			className="h-4 w-4"
		/>
	</PaginationLink>
);
...
const PaginationEllipsis = ({
	...
	>
		<IconDots
			data-uniq-id="24e50930-d0ca-4f1d-bbdb-e0ee5684ad86"
			className="h-4 w-4"
		/>
		<span
			data-uniq-id="567d104f-599a-43e9-9807-542ef4e18a4b"
			className="sr-only"
		>
			More pages
		</span>
						...
						<Pagination data-uniq-id="9caf2d03-62ad-4d6e-a350-1f7f1ef47b7b">
							<PaginationContent data-uniq-id="d8f3029a-f472-48e0-b19d-7d04d216588f">
								...
								{visiblePages.map((page, index) => (
									<PaginationItem
										data-uniq-id="07daa8de-8482-4b11-9375-459034e8e018"
										key={index}
									>
										{page === '...' ? (
