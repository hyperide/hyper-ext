...
describe('DocumentTree', () => {
  ...
  describe('clone', () => {
    ...
    it('should clone children recursively', () => {
      const parent = tree.insert('Container', {});
      const _child1 = tree.insert('Button', {}, parent.id);
      const _child2 = tree.insert('Input', {}, parent.id);
  ...
  describe('tree traversal', () => {
    ...
    it('should get descendants', () => {
      const parent = tree.insert('Container', {});
      const child1 = tree.insert('Button', {}, parent.id);
      const _grandChild1 = tree.insert('Input', {}, child1.id);
      const _child2 = tree.insert('Button', {}, parent.id);
  ...
  describe('serialization', () => {
    it('should create snapshot', () => {
      const _instance1 = tree.insert('Button', {});
      const _instance2 = tree.insert('Input', {});
